<?php
/**
 * Calculate Booking Amount for Online Parking Admin Panel
 * 
 * This file handles AJAX requests to calculate booking amounts based on
 * start time, end time, and hourly rate.
 */
